...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  private static ResponseEntity<Object> buildResponseEntityFromApiError(ApiError apiError) {
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
      ...
      HttpStatus status,
      WebRequest request) {
    return buildResponseEntityFromApiError(HttpStatus.BAD_REQUEST, "Validation error");
  }
